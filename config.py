...
_CASHIER_CANDIDATES = [
    os.path.join(os.path.dirname(BASE_DIR), "cashier", "assets", "fonts"),  # sibling: Desktop/col/prot -> Desktop/col/cashier (col internal)
    os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), "cashier", "assets", "fonts"),  # Desktop/col/prot -> Desktop/cashier (حقيقي)
    ...
    "/home/kali/Desktop/cashier/assets/fonts",  # مسار مباشر للكاشير
